			...
			<div class="container">
				<div class="signup-content">
					<div class="signup-form">
						...
						<form method="POST" action="regCustomer" class="register-form"
							id="register-form">
							<div class="form-group">
								<label for="name"><i
									class="zmdi zmdi-account material-icons-name"></i></label> <input
									type="text" name="fname" id="fname" placeholder="Your First Name" required="required" />
							</div>
							<div class="form-group">
								<label for="name"><i
									class="zmdi zmdi-account material-icons-name"></i></label> <input
									type="text" name="lname" id="lname" placeholder="Your Last Name" required="required"/>
							</div>
							<div class="form-group">
					...
					<div class="signup-image">
						<figure>
							<img src="images/img2.png" alt="sing up image">
						</figure>
...
<script type="text/javascript">
    ...
    if (status == "success") {
        ...
        Swal.fire({
            ...
            text: "Please check your entered values and try again.",
            icon: "error",
            confirmButtonText: "OK"
        });
    }
